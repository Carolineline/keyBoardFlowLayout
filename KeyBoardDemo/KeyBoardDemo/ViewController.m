...
@interface ViewController ()<YTKeyBoardDelegate,UITableViewDataSource,UITableViewDelegate>
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSString * message = self.infoArray[indexPath.row];
...
- (void)clearDataSource{
    if (self.infoArray.count == 0) return;
    for (NSString * m in self.infoArray) {
//        [Message delobject:m];
